...
function clickChangeIsComplete(){
  var id = $(this).parent().parent().data('id');//this = checkbox
  var url = '/todos/' + id; // /todos/some id
  sendAjaxRequest(url, {}, 'post', 'put', null, function(data){ //send the put b/c we want to update the todo
    console.log(data);
  });
}
