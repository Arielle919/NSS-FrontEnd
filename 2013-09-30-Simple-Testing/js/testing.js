...
//   deepEqual( <actual value>, <expected value>, "What this test id doing" );
...
test( "nashville[0]", function() {
  deepEqual("nashville"[0], "n", "I want to get certain letters in nashville" );
});
...
test( "pig_latin", function() {
  deepEqual(pig_latin("hello"), "elloha", "saying hello in pig latin" );
});
